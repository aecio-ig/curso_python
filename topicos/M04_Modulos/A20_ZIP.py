...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'A20_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'A20_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'A20_descompactado'
...
# agora vamos fazer leitura
with ZipFile(CAMINHO_COMPACTADO, 'r') as zip:
    for arquivo in zip.namelist():
        print(arquivo)

# agora podemos descompactar o zip que fizemos
with ZipFile(CAMINHO_COMPACTADO, 'r') as zip:
